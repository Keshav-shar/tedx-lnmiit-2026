...
export default function PastSpeakers() {
  ...
  const speakers = [
    ...
    { id: 5, name: "Dr. Kamna Chhibber", image: "/images/image2.png", description: "Head of Mental Health at Fortis Healthcare, is a renowned clinical psychologist with over 15 years of experience specializing in Cognitive Behaviour Therapy, relationships, trauma, and abuse.", youtube: "https://youtu.be/n0me_a9Amnk?si=z1uwpYOGEZlwguZM", instagram: "https://www.instagram.com/fortismentalhealth?igsh=MW5qa25hdW05aWhiNw==" },
   ...
   { id: 7, name: "Krishnan Sunderarajan", image: "/images/krishna.png", description: "Founder of LOKA, India's first Metaverse app, Krishnan bridges technology and human experience. His Shark Tank success highlights his forward-thinking insights into the future of digital interaction.", youtube: "https://youtu.be/Z9zx3kWLP6c?si=EfKANslHbtSFKjNd", instagram: "https://www.instagram.com/krish_meister?igsh=dnp4dzNmeG9yZjJs" },
    { id: 8, name: "Dr. Lopa Mudraa", image: "/images/image4.png", description: "Security Evangelist with over two decades of expertise in Information Security.Recognized as a 4x Global 100 Chief Information Security Officer awardee.", youtube: "https://youtu.be/To9sxO9W_Kw?si=v7GvKJygJM71JsQ0"},
    { id: 9, name: "Chinmay Gaur", image: "/images/image5.png", description: "Indian Classical flutist and composer, blending tradition and modernity. His TEDx talk focuses on the transcendental power of music, showing how it bridges cultural and emotional divides", youtube: "https://youtu.be/KyLREMG86r0?si=ltKFggjT3QB82UqO", instagram: "https://www.instagram.com/igaur_chinmay/" },
    ...
    { id: 11, name: "Chetna Balhara", image: "/images/chetna.png", description: "Chetna Balhara is a renowned Indian poet and Instagram influencer known for her heartfelt poetry on love, heartbreak, and everyday struggles. Famous for lines like “Bawal hai ke chore”,her relatable work has captivated audiences. With a strong social media presence and powerful performances.", youtube: "https://youtu.be/357IYm05oQU?si=N5EyhDZmzMzKmn42", instagram: "https://www.instagram.com/chetnabalharaofficial?igsh=bTRmODJoMWx3cWJz" },
