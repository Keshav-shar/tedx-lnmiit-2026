...
const SPEAKERS = [
  ...
  { id: 4, name: "Aishwarya Sridhar", title: "Wildlife Photographer", image: "/images/image2.png",bio:"Aishwarya Sridhar is a wildlife photographer and conservation storyteller who works extensively in the field documenting India's biodiversity. Her work focuses on wildlife, habitats, and conservation issues, using visual storytelling to create awareness around environmental protection and coexistence. Over the years, she has spent significant time working in natural landscapes, developing a deep understanding of the patience, ethics, and responsibility involved in wildlife documentation.",linkedin: "#", instagram: "#" },
  { id: 5, name: "Arihant Jain", title: "Speaker", image: "/images/image3.png", bio: "Arihant Jain is a speaker and professional focused on personal development, career clarity, and mindset building. He works closely with students and young professionals, sharing practical perspectives on growth, discipline, and long-term thinking. His engagements often revolve around helping individuals navigate uncertainty, build consistency, and take ownership of their choices. Through his work, he highlights the value of structure, self-awareness, and intentional decision-making.", linkedin: "#", instagram: "#" },
  { id: 6, name: "Ash Akshay Goel", title: "Entrepreneur", image: "/images/Akshay.jpg", bio: "Ash Akshay Goel is an entrepreneur and professional speaker who works at the intersection of communication, personal growth, and idea execution. His work involves engaging with individuals and organizations on building clarity of thought, confidence, and direction in their personal and professional journeys. He actively participates in speaking engagements, mentoring, and discussions centered around mindset, growth, and intentional action.", linkedin: "#", instagram: "#" },
];
