...
const SPEAKERS = [
  { id: 1, name: "Dr. Tanu Jain", title: "Assistant Director, DRDO", image: "/images/image0.webp", bio: "Former IAS officer and DRDO Assistant Director, Dr. Jain advocates for education and UPSC reforms. Her multifaceted career exemplifies her dedication to creating impact beyond conventional roles.", linkedin: "#", instagram: "#" },
  { id: 2, name: "Gunjan Saini", title: "AI Researcher", image: "/images/image01.webp", bio: "Poet, writer, and founder of @officialletstalk, she fosters emotional well-being through shared stories. Gunjan's creative force helps bridge emotional gaps, making a significant impact in mental health.", linkedin: "#", instagram: "#" },
  { id: 3, name: "Preksha Kaparwan", title: "Founder", image: "/images/image1.webp", bio: "Preksha Kaparwan - the dynamic entrepreneur and storyteller revolutionizing the way we access and understand data! As the Co-Founder and CMO of Alphaa AI, she's on a mission to democratize data using AI and NLP, building a platform that empowers users to interact with data effortlessly. A passionate marketer and a curious technologist, Preksha blends creativity and innovation to drive change.", linkedin: "#", instagram: "#" },
  { id: 4, name: "Aishwarya Sridhar", title: "Wildlife Photographer", image: "/images/image2.webp",bio:"Aishwarya Sridhar is a wildlife photographer and conservation storyteller who works extensively in the field documenting India's biodiversity. Her work focuses on wildlife, habitats, and conservation issues, using visual storytelling to create awareness around environmental protection and coexistence.",linkedin: "#", instagram: "#" },
  { id: 5, name: "Arihant Jain", title: "Speaker", image: "/images/image3.webp", bio: "Arihant Jain is a speaker and professional focused on personal development, career clarity, and mindset building. He works closely with students and young professionals, sharing practical perspectives on growth, discipline, and long-term thinking. His engagements often revolve around helping individuals navigate uncertainty, build consistency, and take ownership of their choices.", linkedin: "#", instagram: "#" },
  { id: 6, name: "Ash Akshay Goel", title: "Entrepreneur", image: "/images/Akshay.webp", bio: "Ash Akshay Goel is an entrepreneur and professional speaker who works at the intersection of communication, personal growth, and idea execution. His work involves engaging with individuals and organizations on building clarity of thought, confidence, and direction in their personal and professional journeys. He actively participates in speaking engagements, mentoring, and discussions centered around mindset and intentional action.", linkedin: "#", instagram: "#" },
];
